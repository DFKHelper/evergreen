        ...
        <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {practitioners.map((practitioner) => (
                    <StaggerItem key={practitioner.name}>
                      <GlassmorphicCard variant="medium" className="p-6 h-full flex flex-col">
                        ...
                        <h3 className="text-xl font-bold text-white mb-1">{practitioner.name}</h3>
                        <p className="text-[#6ff799] font-medium mb-1">{practitioner.title}</p>
                        <p className="text-gray-200 text-sm mb-3 flex-grow">{practitioner.specialty}</p>
                        ...
                        <div className="space-y-2">
                          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="block w-full text-center px-4 py-3 bg-[#6ff799] text-emerald-900 font-semibold rounded-xl hover:bg-[#5ce088] transition-colors"
                            >
                          ...
                          {practitioner.learnMoreUrl && (
                            <Link
                              ...
                              className="block w-full text-center px-4 py-2 border border-[#6ff799]/50 text-[#6ff799] font-medium rounded-xl hover:bg-[#6ff799]/10 transition-colors text-sm"
                            >
          ...
          <section className="py-12 px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
              <FadeIn direction="up" className="text-center mb-12">
                ...
                <p className="text-xl text-[#6ff799] font-semibold">
              ...
              <div className="grid lg:grid-cols-2 gap-8 mb-12">
                <FadeIn direction="right" delay={0.1}>
                  <GlassmorphicCard variant="strong" className="p-8 h-full">
          ...
          <section className="py-12 px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-4xl mx-auto">
              <FadeIn direction="up">
                <GlassmorphicCard variant="medium" className="p-8 md:p-12">
          ...
          {/* CTA Section */}
          <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 text-white text-center">
